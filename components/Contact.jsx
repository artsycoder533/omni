...
function Contact() {
  return (
    <div
      ...
      <div className="flex max-w=[1400px] mx-auto gap-24">
        <form className="flex flex-col max-w-[600px] mx-auto pb-16 gap-8">
          ...
          <button type="submit" className="bg-[#1A8C91] border-none my-6">
            Send Message
          </button>
          <p>Terms of Use</p>
          <p>
        ...
        <div className="flex mb-16">
          ...
          <div className="flex flex-col w-full justify-between">
            <div className="border border-[#1A8C91] flex flex-col justify-between items-center p-4">
